...
document.addEventListener("DOMContentLoaded", function () {
  var connectWalletBtn = document.querySelector(".connect_me");
  var makeHimHighBtn = document.querySelector(".makehimhigh");
  var menuTitle = document.querySelector(".menu_title");
  var highTitle = document.querySelector(".high_title");
  var modal = document.querySelector(".modal");
  var modalBg = document.querySelector(".modal_bg");
  var closeButton = document.querySelector(".close_button");
  var prizeImg = document.querySelector(".prizes_img img");
  var prizeText = document.querySelector(".prize");
  var loadingGifContainer = document.querySelector(".loading_gif_container"); // Add this line
  ...
  function updateCountdown() {
    var lastClickTime = parseInt(localStorage.getItem("lastClickTime"), 10);
    var currentTime = new Date().getTime();
    var elapsedTime = currentTime - lastClickTime;
    var cooldown = 24 * 60 * 60 * 1000; // 24 hours in milliseconds

    if (elapsedTime < cooldown) {
      makeHimHighBtn.setAttribute("disabled", "");
      var remainingTime = cooldown - elapsedTime;
      var hours = Math.floor(remainingTime / (1000 * 60 * 60));
      var minutes = Math.floor(remainingTime % (1000 * 60 * 60) / (1000 * 60));
      var seconds = Math.floor(remainingTime % (1000 * 60) / 1000);
      highTitle.textContent = "".concat(hours.toString().padStart(2, "0"), ":").concat(minutes.toString().padStart(2, "0"), ":").concat(seconds.toString().padStart(2, "0"));
    } else {
  ...
  makeHimHighBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var randomNumber, imageFile, text, currentTime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.t0 = randomNumber;
          _context.next = _context.t0 === 0 ? 8 : _context.t0 === 1 ? 11 : _context.t0 === 2 ? 14 : 17;
          break;
        case 8:
        ...
        case 17:
          ...
          prizeImg.srcset = "".concat(imageFile, " 500w, ").concat(imageFile, " 800w");
